    ...
    <div className="min-h-screen bg-[url('/bg-nature.jpg')] bg-cover bg-center flex items-center justify-center">
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <Link to="/login" className="bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl font-semibold transition-all shadow-lg active:scale-95">
            Masuk ke Aplikasi
          </Link>
          <Link to="/register" className="text-green-700 border-2 border-green-600 py-3 rounded-xl font-semibold hover:bg-green-50 transition-all">
            Daftar Akun Baru
          </Link>
        </div>

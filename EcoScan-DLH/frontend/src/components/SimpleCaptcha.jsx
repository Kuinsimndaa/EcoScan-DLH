    ...
    return (
        <div className="w-full space-y-3">
            ...
            <div className="flex items-center gap-2 px-2">
                ...
                <label className="text-[9px] font-black uppercase text-slate-900 tracking-[0.25em]">Verifikasi</label>
            </div>

            {/* CAPTCHA Display Box - Compact */}
            <div className="flex items-center gap-2">
                <div className="flex-1 relative h-12 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 border-2 border-slate-200 rounded-lg px-3 py-1 font-mono font-black text-sm text-slate-800 tracking-[0.2em] text-center select-none shadow-inner overflow-hidden group flex items-center justify-center" 
                    style={{
                        letterSpacing: '2px',
            ...
            {/* Input Field */}
            <div>
                <label className="text-[8px] font-black uppercase text-slate-500 ml-1 mb-1 block tracking-[0.2em]">Kode</label>
            ...
            {isVerified && (
                <div className="px-3 py-1.5 bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-300 rounded-lg shadow-sm flex items-center gap-1.5">
                    ...
                    <p className="text-[8px] font-black text-green-700 uppercase tracking-wide">✓ Verifikasi Berhasil</p>
                </div>
            )}
        </div>
    );

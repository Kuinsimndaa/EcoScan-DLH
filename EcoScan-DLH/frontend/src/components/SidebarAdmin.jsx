...
import { LayoutDashboard, Truck, FileText, Receipt, LogOut, Shield } from 'lucide-react'; 
...
const SidebarAdmin = () => {
    ...
    return (
        <aside className="fixed top-0 left-0 h-screen w-[20%] bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white flex flex-col z-50 border-r border-slate-800/50 shadow-2xl">
            ...
            <div className="p-6 border-b border-slate-800/50 bg-gradient-to-r from-slate-900/50 to-slate-800/50 backdrop-blur-sm">
                ...
                <h1 className="font-black text-lg italic uppercase text-center tracking-tighter leading-tight">
                    ECOSCAN<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">ADMIN</span>
                </h1>
            </div>

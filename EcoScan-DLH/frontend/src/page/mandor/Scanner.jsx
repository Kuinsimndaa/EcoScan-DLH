...
import { QrCode, ArrowLeft, Camera, RefreshCw, CheckCircle, AlertCircle } from 'lucide-react';
...
const Scanner = () => {
    ...
    return (
        <div className="p-8 bg-gradient-to-b from-slate-50 via-green-50/20 to-slate-50 min-h-screen flex flex-col items-center justify-center">
            <div className="w-full max-w-xl bg-white rounded-3xl shadow-2xl p-10 border border-slate-200/50 text-center">
                
                {/* Header Icon */}
                <div className="inline-block p-5 bg-gradient-to-br from-green-600 to-green-700 rounded-2xl text-white mb-6 shadow-xl shadow-green-300/50 animate-pulse">
                    <QrCode size={44} />
                </div>

                <h2 className="font-black italic uppercase text-4xl text-slate-900 tracking-tighter leading-none mb-2">
                        ...
                        <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                            ...
                            <div className="relative w-64 h-64 border-4 border-green-500 rounded-2xl shadow-2xl shadow-green-500/50">
                                ...
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-green-400 to-transparent animate-pulse" 
                                    style={{animation: 'slideScan 2s infinite'}}></div>
                            </div>
                            
                            {/* Scanning status */}
                            <div className="absolute bottom-12 left-0 right-0 text-center">
                                <div className="inline-block px-6 py-3 bg-green-500/20 border border-green-500/50 rounded-full">
                                    <p className="text-sm font-black text-green-300 uppercase tracking-widest">Scanning...</p>
                                </div>
                            </div>
                        </div>
                    )}
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl py-5 px-6 mb-8 border border-green-200/50">
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black uppercase text-slate-600 tracking-widest">Metode Scan</span>
                        </div>
                    ...
                    <div className="bg-white px-4 py-2 rounded-lg border border-green-100">
                        <p className="text-xs font-bold text-slate-600">Pastikan QR Code terlihat jelas dalam bingkai</p>
                    </div>
                </div>

  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="bg-white rounded-3xl shadow-xl p-8 border border-green-100">
        ...
        <p className="text-gray-500 text-center mb-8">Hubungi tim pengembang EcoScan DLH jika Anda mengalami kendala teknis.</p>
        
        <div className="space-y-4">
          <a href="https://wa.me/62812345678" className="flex items-center gap-4 p-4 bg-green-50 rounded-2xl hover:bg-green-100 transition-all border border-green-200">
        ...
        <div className="mt-10 pt-6 border-t text-center">
           <p className="text-xs text-gray-400 uppercase tracking-widest">Aplikasi Versi 1.0.0 (PWA)</p>
